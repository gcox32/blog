// Global site data. Import from anywhere.

export const SITE_TITLE = 'blog';
export const SITE_DESCRIPTION = 'Slow down. Be kind.';
...
export const SOCIAL = {
	github: 'https://github.com/gcox32',
	x: 'https://x.com/unspammable',
	linkedin: 'https://www.linkedin.com/in/gcoxexcel/',
	email: 'hello@grantcox.net',
};
